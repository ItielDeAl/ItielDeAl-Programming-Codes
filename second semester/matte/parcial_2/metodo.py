...
etiqueta = tk.Label(ventana, text="Calculadora del metodo de Newton-Raphson")
etiqueta.pack(pady=25)#separación superior e inferior


mi_input=tk.Entry(ventana)
mi_input.pack()

def newton_raphson():
    print("Calculando")
boton = tk.Button(ventana, text = "Calcular", command=newton_raphson)


boton.pack(pady=10)


ventana.mainloop()#se ejecuta dentroto de un bucle.
